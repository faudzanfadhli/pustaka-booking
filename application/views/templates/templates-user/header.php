    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <?php } else { ?>
            <a class="nav-item nav-link" data-toggle="modal" datatarget="#daftarModal" href="<?= base_url('/daftar'); ?>"><i class="fas fw fa-login"></i> Daftar</a>
            <a class="nav-item nav-link" data-toggle="modal" datatarget="#loginModal" href="<?= base_url('/login'); ?>"><i class="fas fw fa-login"></i> Log in</a>
          <?php } ?>
